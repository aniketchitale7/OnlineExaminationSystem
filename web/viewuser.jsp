...
<%
        ...
        try {
              Connection con=olexam.dbconnection1.emergencycon();
                 ...
                 String fire="select * from login where username !='aniket7' ";
...
<div class="container">
			...
			<header>
				<h1><span>Online Examination Admin page </span> View Users </h1>
            </header>
            <table width="1187" border="3" align="center">
              <tr>
                ...
                <td width="159"><div align="center"></div>Username</td>
                <td width="164"><div align="center"></div>Gender</td>
                <td width="141"><div align="center"></div>Mobile no</td>
