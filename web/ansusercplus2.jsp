...
if(finalmarks>24)
    ...
    status="fail";
            ...
            String query="UPDATE marks SET cplus='"+finalmarks+"', status='"+status+"' WHERE name='"+user+"'";
  ...
  ResultSet rs=null;
        ...
        try {
              ...
              Connection con=olexam.dbconnection1.emergencycon();
                    ...
                    PreparedStatement st=(PreparedStatement) con.prepareStatement("select qid,que,op1,op2,op3,op4 from cplus where qid=?");
   st.setInt(1,qno);
...
<div class="container">
  ...
  <div  class="form">
      <form action="useranscplus" method="post"> 
