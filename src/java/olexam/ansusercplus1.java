...
public class ansusercplus1 extends HttpServlet {
...
String ans1 = request.getParameter("answer");
            ...
            Connection con=olexam.dbconnection1.emergencycon();
                    ...
                    PreparedStatement st=(PreparedStatement) con.prepareStatement("select ca from cplus where qid=?");
   st.setInt(1,qno);
  ...
  String answer = null;
         ...
         else if(ans1==null)
	  {
        ...
        response.sendRedirect("ansusercplus2.jsp");
